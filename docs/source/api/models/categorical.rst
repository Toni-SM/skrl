...
*skrl* provides a Python mixin (:literal:`CategoricalMixin`) to assist in the creation of these types of models,
...
.. automodule:: skrl.models.torch.categorical
.. autosummary::
    :nosignatures:
...
.. automodule:: skrl.models.jax.categorical
.. autosummary::
    :nosignatures:
