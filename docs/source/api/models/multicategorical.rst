...
*skrl* provides a Python mixin (:literal:`MultiCategoricalMixin`) to assist in the creation of these types of models,
...
.. automodule:: skrl.models.torch.multicategorical
.. autosummary::
    :nosignatures:
...
.. automodule:: skrl.models.jax.multicategorical
.. autosummary::
    :nosignatures:
