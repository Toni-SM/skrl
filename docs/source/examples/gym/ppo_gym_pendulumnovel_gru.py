...
models_ppo = {}
models_ppo["policy"] = Policy(env.observation_space, env.action_space, device, clip_actions=True, num_envs=env.num_envs)
models_ppo["value"] = Value(env.observation_space, env.action_space, device, num_envs=env.num_envs)
