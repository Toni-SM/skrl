...
models_trpo = {}
models_trpo["policy"] = Policy(env.observation_space, env.action_space, device, clip_actions=True, num_envs=env.num_envs)
models_trpo["value"] = Value(env.observation_space, env.action_space, device, num_envs=env.num_envs)
