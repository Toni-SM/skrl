...
if __name__ == "__main__":
    ...
    models_ddpg["policy"] = DeterministicActor(
        env.observation_space, env.state_space, env.action_space, device, clip_actions=True
    )
    ...
    trainer = ParallelTrainer(
        cfg=cfg_trainer, env=env, agents=[agent_ddpg, agent_td3, agent_sac], scopes=[1, 1, 1]
    )  # scopes (3 envs): DDPG 1, TD3 1 and SAC 1
