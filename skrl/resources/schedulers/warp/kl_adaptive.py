...
def KLAdaptiveLR(
    *,
    ...
    :return: A function that maps step counts, current learning rate and KL divergence to the new learning rate value.
        If no learning rate is specified, 1.0 will be returned to mimic the JAX's scheduler behaviors.
...
# Alias to maintain naming compatibility with JAX implementation
